...
missing values, distributed as we observed in [the first section](#preprocess). In view of what we observed there, to fill in the NAs I decide to impute the missing data by using the average of the ones from the same interval in the other days, taking advantage fo the fact that R recycles vectors.
...
# this time I decide to use dplyr, for the sake of elegancy
library(dplyr)
